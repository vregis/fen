        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Список номеров представлен ниже</h3>
                    <div class="box-tools">
                ...
                <div class="box-body table-responsive no-padding">
                            ...
                            [
                                ...
                                'buttons' => [
                                    'childs' => function($url, $model){
                                        ...
                                        return Rooms::existsChilds($model->id)
                    ...
                    echo Html::tag('div', Html::a('Добавить', Url::toRoute(['/rooms/add']), ['class' => 'btn btn-block btn-primary']), [
                        'class' => 'button-add'
                    ]);
                    ?>
                </div>
